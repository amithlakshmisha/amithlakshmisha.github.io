...
/** Shared contact links — rendered as cards in the contact section and as icons in the footer. */
export const SOCIAL_LINKS: SocialLink[] = [
  {
    label: "Email Me",
    sub: "amithlakshmisha@gmail.com",
    href: "mailto:amithlakshmisha@gmail.com",
    icon: (
      <svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
...
/** Props for an anchor tag pointing at a social link. */
export const linkProps = (l: SocialLink) => ({
  href: l.href,
